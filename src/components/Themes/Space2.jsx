...
import planet3 from '../images/p3.png'
            ...
            <Font family='Orbitron'>
                <div ref={ref} className='h-[120vh] relative'>
                    ...
                    <motion.div className="absolute z-[11]" style={{ y: textY, x: p4, top: 'calc(60% - 1rem)', right: 'calc(30% - 2rem)' }}>
                        <img className='rotate-planet4 h-[10vh] ' src={planet4} alt="" />
                    </motion.div>

                    <motion.div className='bg-transparent absolute z-[49] text-white flex flex-col justify-center items-center pt-16 pl-44' style={{ y: compY, top: 'calc(25% - 1rem)' }}>
                ...
                <div className='relative h-[120vh]'>
                    ...
                    <Parallax className='relative h-[120vh] bg-cover bg-bottom' strength={600} bgImage={bgimage}>
                        ...
                        <motion.div className="absolute top-[40vh] z-10" style={{ x: p1, left: 'calc(70% - 5rem)' }}>
                            <img className='rotate-planet2 h-[20vh] ' src={planet2} alt="" />
                        </motion.div>
                        <motion.div className="absolute z-[10] -top-[10vh]" style={{ y: p3, right: 'calc(60% - 5rem)' }}>
                            <img className='rotate-planet3 h-[30vh] ' src={planet3} alt="" />
                        </motion.div>
                    </Parallax>
                    <div className='h-[40vh] w-full absolute z-40 bottom-0' style={{ background: 'linear-gradient(to top, black, transparent)' }}></div>
                </div>
