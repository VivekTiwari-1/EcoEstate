...
const Navbar = () => {
    return (
        <div className='Container bg-[#a7abaa] flex justify-between items-center m-10 p-7 h-[10vh] w-[94vw] shadow-md shadow-grey absolute z-10'>
            <div className='flex'>
            ...
            <div className="NavComponents flex justify-between items-center gap-10 font-large">
                <ul className="flex justify-between items-center gap-7 font-medium mr-7">
                    <li className='hover:text-[#00B98E] cursor-pointer'><Link to="/signup">HOME</Link></li>
